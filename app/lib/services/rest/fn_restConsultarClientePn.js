...
async function fn_restVinculaClientePn(dataReques) {
    ...
    console.log('dataReques PN:', dataReques);

    const rawData = await bearerToken.fn_restCognito();
    console.log('cognito puro PN:', rawData);
    const access_token = JSON.parse(rawData).rawData;
    console.log('cognito Parse PN:', access_token);
    ...
    console.log('CLIENTEPN_HOST:', CLIENTEPN_HOST);
    console.log('CLIENTEPN_PORT:', CLIENTEPN_PORT);
    console.log('CLIENTEPN_PATH:', CLIENTEPN_PATH);
    ...
    console.log('options PN:', options)
    ...
    let promise = new Promise(function (resolve, reject) {
        const req = https.request(options, function (res) {
            ...
            console.log('error reject PN:', error);
        ...
        console.log('postData PN:', postData);
