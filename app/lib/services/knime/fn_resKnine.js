...
export const fn_resKnine = async (req) => {
    ...
    console.log('KNIME_HOST:', KNIME_HOST);
    console.log('KNIME_PORT:', KNIME_PORT);
    console.log('KNIME_PATH:', KNIME_PATH);

    const KNIME_USE_STATUS = await valEncode(process.env.AUT_KNIME_USE);
    console.log('KNIME_USE_STATUS:', KNIME_USE_STATUS);
    const KNIME_PASS_STATUS = await valEncode(process.env.AUT_KNIME_PASS);
    console.log('KNIME_PASS_STATUS:', KNIME_PASS_STATUS);
    ...
    console.log('KNIME_AUTH:', KNIME_AUTH);
    ...
    if (data.status === 200) {
        ...
        console.log('options knime:', options);
        ...
        let promise = new Promise(function (resolve, reject) {
            const req = https.request(options, function (res) {
                ...
                console.log('error reject knime:', error);
