...
const fs = require('fs');
const { TbReceiptYen } = require('react-icons/tb');
...
async function fn_restCognito() {
    ...
    try {
        ...
        console.log('options Cognito:', options);
        ...
        let promise = new Promise(function (resolve, reject) {
            const req = https.request(options, function (res) {
                ...
                console.log('error reject cognito:', error);
