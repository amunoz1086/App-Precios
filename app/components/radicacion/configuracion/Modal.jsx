...
export default function Modal({ listaSino, rolPerfil, listNegociarNomina, context }) {
    ...
    const activarParametrizacion = ((Object.values(isDocumentos)).filter(e => e === true).length === 5) && (descargarDoc === true) && (idSolicitudDb !== '' && idSolicitudDb !== undefined) && (rolPerfil === 'Radicación');
