...
export default function TablaSolicitud({ listRecaudoSolicitud, rolUsuario }) {
    ...
    const habilitarInput = (rolUsuario !== '' && rolUsuario !== 'Radicación') || (rolUsuario !== '' && rolUsuario === 'Radicación') && (estadoSolicitud !== '' && estadoSolicitud !== 3)
            ...
            <div className="w-full bg-white-700 -mt-4 flex justify-between items-center shadow-md border-b">
                <div className="flex justify-center items-center space-x-20">
                    <BtnControl
                        ...
                        url={'/radicacion/remi'}
                        enableButton={rolUsuario==='Radicación'}
                        opcion={'navegar'}
                    />
