...
import { conversionPesos, transformaValorPesos } from '@/app/lib/utils';
                        ...
                        <div className="tab-content " id="tab-1 ">
                            <section className="container flex flex-row">
                                <div className=" w-1/2 px-2 py-1  flex flex-row gap-4">
                                    <CardResumen listTypeProducts={listTypeProducts} listTipeOperactions={listTipeOperactions} solicitud={solicitud} />
                                </div>
                            ...
                            <section className="w-full py-1">
                                ...
                                <InformacionProductosServicios
                                    ...
                                    resetResultados={onResetResultados}
                                />
                                <ResumenSolicitudCaptacion
                                    depositoVista={depositoVista}
                                    resetResultados={onResetResultados}
                                />
                            </section>
                        </div> : undefined
