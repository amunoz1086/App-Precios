...
export default function EspecificacionContrato({ dataContext, listNegociarNomina }) {
    ...
    const soloConvenioFinanciero = true; //(solicitud?.tipoConvenio?.convenioPago === undefined && 
    // solicitud?.tipoConvenio?.convenioRecaudo === undefined) || solicitud?.tipoProducto.credito === '01' && 
    // solicitud?.tipoProducto.convenio === undefined
...
*  */
    ...
    let vFact1 = (convenioRecaudo.adquirencia[0]?.facturacion === '' ? 0 : parseInt(convenioRecaudo.adquirencia[0]?.facturacion));
    let vFact2 = (convenioRecaudo.adquirencia[1]?.facturacion === '' ? 0 : parseInt(convenioRecaudo.adquirencia[1]?.facturacion));
    let vFact3 = (convenioRecaudo.adquirencia[2]?.facturacion === '' ? 0 : parseInt(convenioRecaudo.adquirencia[2]?.facturacion));
    let vFact4 = (convenioRecaudo.adquirencia[3]?.facturacion === '' ? 0 : parseInt(convenioRecaudo.adquirencia[3]?.facturacion));
    let vFact5 = (convenioRecaudo.adquirencia[4]?.facturacion === '' ? 0 : parseInt(convenioRecaudo.adquirencia[4]?.facturacion));
    let vFact6 = (convenioRecaudo.adquirencia[5]?.facturacion === '' ? 0 : parseInt(convenioRecaudo.adquirencia[5]?.facturacion));
