...
export default function EspecificacionContrato({ dataContext, listNegociarNomina }) {
    ...
    const validarConvenioPagoTerceros = () => {
        let contadorConvenioPagoTerceros = 0;
        for (const i of convenioPago.convenioPagoTerceros) {
            if (i.hasOwnProperty('cantidadNueva')) {
                if (i.cantidadNueva !== '') {
                    contadorConvenioPagoTerceros++;
                };
            };
        };
        return contadorConvenioPagoTerceros;
    };

    const validarRecaudoOficina = () => {
        let contadorRecaudoOficina = 0;
        for (const i of convenioRecaudo.recaudoOficina) {
            if (i.hasOwnProperty('cantidad')) {
                if (i.cantidad !== '') {
                    contadorRecaudoOficina++;
                }
            };
        };
        return contadorRecaudoOficina;
    };

    const validarRecaudoPse = () => {
        let contadorPSE = 0;
        for (const i of convenioRecaudo.recaudoPSE) {
            if (i.hasOwnProperty('cantidad')) {
                if (i.cantidad !== '') {
                    contadorPSE++;
                }
    ...
    const validarrecaudoCorresponsales = () => {
        let contadorCorresponsales = 0;
        for (const i of convenioRecaudo.recaudoPSE) {
            if (i.hasOwnProperty('cantidad')) {
                if (i.cantidad !== '') {
                    contadorCorresponsales++;
                }
            };
        };
        return contadorCorresponsales;
    };

    const validarServicioFinanciero = () => {
        let contador = 0;
        for (const i of servicioFinanciero.solicitud) {
            if (i.hasOwnProperty('cantidad')) {
                if (i.cantidad !== '') {
                    contador++;
                }
    ...
    const validacionesFormulario = {
        'adquirencia': () => {
            ...
            const validTipoCuenta1 = Array.isArray(tipoCuenta1) ? (tipoCuenta1?.some(e => e.cuenta !== 'default' && e.cuenta !== '' && e.codCuenta !== '' && e.porcentaje !== '')) : false;
        ...
        'convenioRecaudo': () => {
            ...
            const cuentaRecaudodaraValidacion = (cuentaRecaudodora.filter(e => e.numCuenta !== '' && e.tipoCuenta !== '')).length > 0;
        ...
        'corresponsal': () => {
            ...
            const validacionCuentaEan = (cuentaRecaudadoraEan.filter(e => e.numCuentaCorresponsales !== '' && e.eanCorresponsales !== '' && (e.tipoCuentaCorresponsales !== '' && e.tipoCuentaCorresponsales !== 'default'))).length > 0;
    ...
    const soloConvenioFinanciero = validarServicioFinanciero() > 0 && validRecuado === undefined;
    ...
    let vFact1 = (convenioRecaudo.adquirencia[0]?.facturacion === '' || convenioRecaudo.adquirencia[0]?.facturacion === undefined ? 0 : parseInt(convenioRecaudo.adquirencia[0]?.facturacion));
    let vFact2 = (convenioRecaudo.adquirencia[1]?.facturacion === '' || convenioRecaudo.adquirencia[1]?.facturacion === undefined ? 0 : parseInt(convenioRecaudo.adquirencia[1]?.facturacion));
    let vFact3 = (convenioRecaudo.adquirencia[2]?.facturacion === '' || convenioRecaudo.adquirencia[2]?.facturacion === undefined ? 0 : parseInt(convenioRecaudo.adquirencia[2]?.facturacion));
    let vFact4 = (convenioRecaudo.adquirencia[3]?.facturacion === '' || convenioRecaudo.adquirencia[3]?.facturacion === undefined ? 0 : parseInt(convenioRecaudo.adquirencia[3]?.facturacion));
    let vFact5 = (convenioRecaudo.adquirencia[4]?.facturacion === '' || convenioRecaudo.adquirencia[4]?.facturacion === undefined ? 0 : parseInt(convenioRecaudo.adquirencia[4]?.facturacion));
    let vFact6 = (convenioRecaudo.adquirencia[5]?.facturacion === '' || convenioRecaudo.adquirencia[5]?.facturacion === undefined ? 0 : parseInt(convenioRecaudo.adquirencia[5]?.facturacion));

    let sumAdquirenciaFacturacion = conversionPesos({ valor: (vFact1 + vFact2 + vFact3 + vFact4 + vFact5 + vFact6) });
    ...
    const sumaDebitoMaster = (convenioRecaudo.adquirencia[1]?.facturacion) || (convenioRecaudo.adquirencia[3]?.facturacion) ? conversionPesos({ valor: (parseInt(vFact2 !== '' ? vFact2 : 0) + parseInt(vFact4 !== '' ? vFact4 : 0)) }) : '';
    const sumaVisaMaster = (convenioRecaudo.adquirencia[0]?.facturacion) || (convenioRecaudo.adquirencia[4]?.facturacion) ? conversionPesos({ valor: (parseInt(vFact1 !== '' ? vFact1 : 0) + parseInt(vFact5 !== '' ? vFact5 : 0)) }) : '';
            ...
            <Page wrap size={'LETTER'} style={{ padding: "0 13px" }}>
                ...
                <View style={{ fontWeight: "normal" }}>
                    ...
                    <View style={{ display: "flex", flexDirection: "row", justifyContent: "space-between", alignItems: "center", gap: 8, fontSize: 7, marginTop: "4px" }}>
                        ...
                        <View style={{ display: "flex", flexDirection: "row", justifyContent: "center", gap: 6 }}>
                            <Text style={{ borderBottom: "0.5px", width: "10px", textAlign: "center" }}>{validarrecaudoCorresponsales() > 0 ? "X" : null}</Text>
                        ...
                        <View style={{ display: "flex", flexDirection: "row", justifyContent: "center", gap: 6 }}>
                            <Text style={{ borderBottom: "0.5px", width: "10px", textAlign: "center" }}>{validarRecaudoOficina() > 0 ? "X" : null}</Text>
                            <Text>Convenio de Recaudo</Text>
                        </View>
                        <View style={{ display: "flex", flexDirection: "row", justifyContent: "center", gap: 6 }}>
                            <Text style={{ borderBottom: "0.5px", width: "10px", textAlign: "center" }}>{validarRecaudoPse() > 0 ? "X" : null}</Text>
                            <Text>PSE</Text>
                        </View>
                        <View style={{ display: "flex", flexDirection: "row", justifyContent: "center", gap: 6 }}>
                            <Text style={{ borderBottom: "0.5px", width: "10px", textAlign: "center" }}>{validarConvenioPagoTerceros() > 0 ? "X" : null}</Text>
                            ...
                            <View style={{ display: "flex", flexDirection: "row", justifyContent: "space-between", border: "0.5", padding: "4px 8px" }} >
                                ...
                                <View>
                                    ...
                                    <View style={{ display: "flex", flexDirection: "row", justifyContent: "space-between", gap: 20, marginTop: "3px" }} >
                                        ...
                                        <View style={{ display: "flex", flexDirection: "row", gap: 10 }} >
                                            <Text style={{ borderBottom: "0.5px", width: "60px", textAlign: "center" }}>{tarjetaCreditoServicioFinanciero?.cantidad || ''}</Text>
                                            <Text style={{ borderBottom: "0.5px", width: "70px", textAlign: "center" }}>{tarjetaCreditoServicioFinanciero?.tarifaNegociada ? conversionPesos({ valor: tarjetaCreditoServicioFinanciero?.tarifaNegociada }) : ''}</Text>
                                        </View>
                                    </View>
                                    <View style={{ display: "flex", flexDirection: "row", justifyContent: "space-between", gap: 20, marginTop: "3px" }} >
                                        <Text>Giros</Text>
                        ...
                        <View style={{ fontSize: 8 }}>
                            ...
                            <View>
                                ...
                                <View style={{ display: "flex", flexDirection: "row", justifyContent: "space-between", margin: "6px 8px 6px 8px" }}>
                                    ...
                                    <Text style={{ borderBottom: "0.5px", width: "70px", textAlign: "center" }}>{sumAdquirenciaFacturacion}</Text>
                                    ...
                                    <View style={{ width: "75%" }} >
                                        {
                                            cuentaRecaudodora?.map((ean, i) => {
                                                let filaValida = (ean.tipoCuenta === '1' || ean.tipoCuenta === '2') && (ean?.numCuenta && ean?.numCuenta !== '') && (ean?.eanr && ean?.eanr !== '');
                                                if (!filaValida) {
                                                    return null;
                                                };
                                                return (
                                                    <View key={i} style={{ marginTop: "3px", width: "100%", display: "flex", flexDirection: "row", justifyContent: "space-between" }}>
                                                        ...
                                                        <Text style={{ borderBottom: "0.5px", width: "80px", textAlign: "center" }}>{ean?.codCuenta}</Text>
                                                        <Text>EAN</Text>
                                                        <Text style={{ borderBottom: "0.5px", width: "60px", textAlign: "center" }}>{ean?.eanr}</Text>
                                                        <View style={{ display: "flex", flexDirection: "row" }}>
                                                            <Text>Ahorro</Text>
                                                            <Text style={{ borderBottom: "0.5px", width: "60px", textAlign: "center" }}>{ean?.tipoCuenta === '1' ? 'x' : ''}</Text>
                                                        </View>
                                                        <View style={{ display: "flex", flexDirection: "row" }}>
                                                            <Text>Corriente</Text>
                                                            <Text style={{ borderBottom: "0.5px", width: "60px", textAlign: "center" }}>{ean?.tipoCuenta === '2' ? 'x' : ''}</Text>
                                                        </View>
                                                    </View>
                                                )
                                            }
                                ...
                                <View style={{ display: "flex", flexDirection: "column", gap: 15, marginTop: "9px" }}>
                                    <Text>No Cuenta de recaudadora</Text>
                                    {
                                        cuentaRecaudadoraEan?.map((e) => {
                                            let filaValida = (e?.numCuentaCorresponsales && e?.numCuentaCorresponsales != '')
                                            if (!filaValida) {
                                                return null;
                                            }
                                            return (
                                                <Text key={e.id + 'recaudocuenta'} style={{ borderBottom: "0.2px", width: "auto", textAlign: "center" }}>{e?.codCuentaCorresponsales}</Text>
                                            )
                                        }
                                        )
                                    }
                        ...
                        <View style={{ fontSize: 8 }}>
                            ...
                            <View style={{ border: "0.5px", display: "flex", flexDirection: "row", justifyContent: "space-between", padding: "8px 8px", marginTop: "4px" }}>
                                ...
                                <View style={{ display: "flex", flexDirection: "row", gap: 14 }}>
                                    ...
                                    <Text style={{ borderBottom: "0.5px", width: "250px", textAlign: "center", marginTop: "2px" }}>{cuentaPagadoraPagoNomina?.codCuenta || ''}</Text>
                                </View>
                            </View>
                            {/* Proveedores */}
                            ...
                            <View style={{ display: "flex", flexDirection: "row", justifyContent: "space-between", padding: "5px 8px" }}>
                                ...
                                <View>
                                    ...
                                    <View style={{ display: "flex", flexDirection: "row", margin: "9px 0px 0px 0px" }}>
                                        <Text style={{ borderBottom: "0.5px", width: "60px", textAlign: "center" }}>{validarConvenioPagoTerceros() > 0 ? frecuenciaPago : ''}</Text>
                                        <Text></Text>
                                    </View>
                                </View>
                            </View>
                            <View style={{ display: "flex", flexDirection: "row", gap: 10, marginTop: "10px" }} >
                                <Text>Número de Cuenta Pagadora:</Text>
                                <Text style={{ borderBottom: "0.5px", width: "280px", textAlign: "center" }}>{cuentaRecaudadora2[0]?.codCuenta}</Text>
                            </View>
                            ...
                            <View style={{ display: "flex", flexDirection: "row", gap: 4, marginBottom: "6px" }}>
                                <Text>Número de Cuenta Pagadora:</Text>
                                <Text style={{ borderBottom: "0.5px", width: "280px", textAlign: "center" }}>{cuentaPagadoraPagoNomina?.codCuenta}</Text>
                            </View>
                            {/* Uso Exclusivo Bancoomeva para Convenios de Pago Proveedores */}
                            {/* **** */}
