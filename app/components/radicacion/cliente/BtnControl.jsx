...
export default function BtnControl({ name, context, arial_label, url, handleTabClick, cliente, resetResultados,
  ...
  frmId, frmId2, paddingX, functionEvaluarSolcitud, solicitarAprobacion, finalizarParametrizacion, editarCliente, functionContinuar, enviarParametrizar, updateRutaActual, updateRutaAnterior }) {
